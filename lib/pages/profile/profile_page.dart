    ...
    return Container(
      ...
      child: ListView(
        children: <Widget>[
          ...
          WeTile(
            iconPath: 'images/ic_collections.png',
            title: '收藏',
            borderBottom: true,
            onPressed: () {
              Navigator.of(context).pushNamed('/detail', arguments: { 'title': '支付' });
          ...
          WeTile(
            iconPath: 'images/ic_cards_wallet.png',
            title: '卡包',
            borderBottom: true,
            onPressed: () {
              Navigator.of(context).pushNamed('/detail', arguments: { 'title': '支付' });
          ...
          WeTile(
            iconPath: 'images/ic_emotions.png',
            title: '表情',
            onPressed: () {
              Navigator.of(context).pushNamed('/detail', arguments: { 'title': '支付' });
            }
          ...
          WeTile(
            iconPath: 'images/ic_settings.png',
            title: '设置',
            onPressed: () {
              Navigator.of(context).pushNamed('/detail', arguments: { 'title': '支付' });
            }
